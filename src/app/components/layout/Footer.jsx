      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="pt-8 border-t border-[var(--border-divider-on-navy)] flex flex-col-reverse md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="#" className="w-10 h-10 rounded-md border border-[var(--border-divider-on-navy)] flex items-center justify-center text-[var(--text-body-on-navy)] hover:text-white hover:border-amber transition-colors">
