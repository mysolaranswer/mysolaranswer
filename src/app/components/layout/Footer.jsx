      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-4">
            ...
            <form className="relative flex max-w-md">
              ...
              <button 
                type="submit" 
                className="absolute right-1 top-1 bottom-1 px-8 rounded-full bg-amber text-black text-base font-bold hover:opacity-90 transition-opacity"
              >
                Send
              </button>
            </form>
        ...
        <div className="pt-8 border-t border-[var(--border-divider-on-navy)] flex flex-col-reverse md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="#" className="w-10 h-10 rounded-full border border-[var(--border-divider-on-navy)] flex items-center justify-center text-[var(--text-body-on-navy)] hover:text-white hover:border-amber transition-colors">
