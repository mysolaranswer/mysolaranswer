      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-4">
              <li><Link href="/" className="text-base text-[var(--text-body-on-navy)] hover:text-amber transition-colors">Home</Link></li>
              <li><Link href="/calculators" className="text-base text-[var(--text-body-on-navy)] hover:text-amber transition-colors">Calculators</Link></li>
              <li><Link href="/about" className="text-base text-[var(--text-body-on-navy)] hover:text-amber transition-colors">About</Link></li>
              <li><Link href="/blog" className="text-base text-[var(--text-body-on-navy)] hover:text-amber transition-colors">Blog</Link></li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-4">
              <li className="flex items-center gap-3 text-[var(--text-body-on-navy)] text-base break-all">
                <a href="mailto:mysolaranswer@gmail.com" className="flex items-center gap-3 hover:text-amber transition-colors">
          ...
          <div className="lg:col-span-4">
            ...
            <form className="relative flex max-w-md">
              <input 
                ...
                className="w-full bg-white text-black px-5 py-3.5 rounded-md outline-none focus:ring-2 focus:ring-amber pr-32"
                required
              />
              <button 
                type="submit" 
                className="absolute right-1 top-1 bottom-1 px-8 rounded-md bg-amber text-black text-base font-bold hover:opacity-90 transition-opacity"
              >
                Send
              </button>
            </form>
        ...
        <div className="pt-8 border-t border-[var(--border-divider-on-navy)] flex flex-col-reverse md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="#" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-md border border-[var(--border-divider-on-navy)] flex items-center justify-center text-[var(--text-body-on-navy)] hover:text-white hover:border-amber transition-colors">
            ...
            <a href="https://x.com/mysolaranswer" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-md border border-[var(--border-divider-on-navy)] flex items-center justify-center text-[var(--text-body-on-navy)] hover:text-white hover:border-amber transition-colors">
            ...
            <a href="https://www.instagram.com/mysolaranswer/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-md border border-[var(--border-divider-on-navy)] flex items-center justify-center text-[var(--text-body-on-navy)] hover:text-white hover:border-amber transition-colors">
            ...
            <a href="https://www.linkedin.com/company/my-solar-answer" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-md border border-[var(--border-divider-on-navy)] flex items-center justify-center text-[var(--text-body-on-navy)] hover:text-white hover:border-amber transition-colors">
