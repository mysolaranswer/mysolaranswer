      ...
      {!results ? (
        ...
        <div className="flex flex-col gap-5 animate-fade-in-up">
          <div className="flex justify-between items-center mb-1">
            <h3 className="font-bold text-white text-lg">Your Solar Estimate</h3>
            <button 
              onClick={() => setResults(null)} 
              className="text-xs font-bold text-[var(--color-amber)] hover:underline uppercase tracking-wider"
            >
              Recalculate
            </button>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 border-y border-[var(--border-divider-on-navy)] py-6">
            ...
            <div className="flex flex-col gap-1">
              ...
              <span className="text-xl font-bold text-[var(--color-amber)]">${results.monthlySavings} / mo</span>
            </div>

          </div>

          <p className="text-xs text-[var(--text-body-on-navy)] opacity-80 leading-relaxed mt-1">
